...
import type { Vendor } from '@alexandrecastillo/builderbot-bot/dist/provider/interface/provider'
import type { BotContext, Button, GlobalVendorArgs, SendOptions } from '@alexandrecastillo/builderbot-bot/dist/types'
